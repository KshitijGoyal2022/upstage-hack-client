					...
					<div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl transform transition-all duration-300 p-10 space-y-8">
						...
						<div className="flex items-center justify-between space-x-4">
							<div>
								...
								<p className="text-gray-600 mt-1 text-sm">
									Total Duration:{" "}
									{millisecondsToDuration(bestFlight.total_duration)}
								</p>
							</div>
							{/* Airline logo */}
						...
						<div className="space-y-6 divide-y divide-gray-200">
							{bestFlight.flights.map((flight, index) => (
								<div
									key={index}
									className="pt-4 space-y-4 hover:bg-gray-50 rounded-md p-4 transition-all duration-300"
								>
									...
									<div className="grid grid-cols-2 gap-6">
										<div className="space-y-2">
											...
											<p className="flex items-center text-gray-600">
												...
												Arrival:{" "}
												{new Date(flight.arrival_airport.time).toLocaleString()}
											</p>
											<p className="flex items-center text-gray-600">
										...
										<div className="space-y-2">
											...
											{props.flight.layovers.length > index && (
												<p className="flex items-center text-gray-600">
													...
													Layover at {
														props.flight.layovers[index].name
													} for{" "}
